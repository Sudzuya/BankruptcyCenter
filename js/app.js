(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-team")) new core(".swiper-team", {
    ...
    buttons.forEach((function(item) {
        item.addEventListener("click", (function() {
            ...
            if (item.classList.contains("quiz__next") && currentStepNumber + 1 < allSteps.length) {
                ...
                if (0 == prevEl.getAttribute("data-step") && consultationButton.classList.contains("proggress")) consultationButton.classList.remove("proggress");
    ...
    let event_forms = document.querySelectorAll("form");
    event_forms.forEach((function(form) {
        ...
        input.forEach((function(field) {
            field.addEventListener("input", (function() {
                if (0 === field.value.length && field.classList.contains("valid")) {
                ...
                if ("tel" === field.type) {
                    ...
                    if (valueTel < 18) field.classList.add("invalid"); else if (field.classList.contains("invalid")) {
                        field.classList.remove("invalid");
                        field.classList.add("valid");
                    }
                    if (warningMassage.classList.contains("invalid") && 18 === valueTel) {
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        ...
        activeArticlesNumber += articleNumber;
    ...
    let breadcrumbs = "";
    if (0 != breadcrumbs.length) breadcrumbs = document.querySelector(".breadcrumbs").querySelector(".breadcrumbs__this-page").textContent = document.title;
    let stickyNav = "";
    if (void 0 !== stickyNav) {
        ...
        sticlyLink.forEach((function(item) {
            if (window.innerWidth <= 1024) item.setAttribute("data-goto-top", "80"); else item.setAttribute("data-goto-top", "20");
        }));
        if (window.innerWidth <= 1024) stickyNav.setAttribute("data-sticky-header", ""); else stickyNav.removeAttribute("data-sticky-header");
    ...
    tabTitle.forEach((function(item) {
        item.addEventListener("click", (function() {
            ...
            tabTitle.forEach((function(el) {
                if (el != item) el.classList.remove("_tab-active");
            }));
        }));
    }));
    ...
    form_form.forEach((function(item) {
        ...
        async function formSend(e) {
            e.preventDefault();
            let error = form_formValidate(item);
            if (false == error) {
    ...
    function form_formValidate(form) {
        ...
        inputs.forEach((function(item) {
            ...
            if (item.classList.contains("tel")) {
                ...
                if (12 !== number.length) {
                    ...
                    error = true;
                } else errorField.classList.remove("invalid");
            }
            if (item.classList.contains("check")) if (!item.checked) error = true;
        }));
        return error;
    }
    window["FLS"] = true;
